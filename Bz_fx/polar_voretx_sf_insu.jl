...
function ImplementBCs_cheb!(Op, diffMatrix, params)
    ...
    for iter ∈ 1:n-1
         diffMatrix.𝒟³ᶻᴺ[1, iter+1] = (diffMatrix.𝒟³ᶻᴺ[1, iter+1] - 
                                    diffMatrix.𝒟³ᶻᴺ[1, 1] * diffMatrix.𝒟ᶻᴺ[1, iter+1] / diffMatrix.𝒟ᶻᴺ[1, 1])

        diffMatrix.𝒟³ᶻᴺ[n, iter]    = (diffMatrix.𝒟³ᶻᴺ[n, iter]   - 
                                    diffMatrix.𝒟³ᶻᴺ[n, n] * diffMatrix.𝒟ᶻᴺ[n, iter]   / diffMatrix.𝒟ᶻᴺ[n, n])
    end
...
function solve_PolarVortex()
    ...
    Nx::Int = params.Nx
    Nz::Int = params.Nz 
    filename = "benchmark/eigenvals_sf_insu_"  * "_elssaer" * string(Λ) * "_" * string(Nz) * string(Nx) * ".jld2"
